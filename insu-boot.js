...
(function () {
  ...
  /* Contact popup. The business CTA used to be a bare mailto:, which
     does nothing visible when no mail client is configured — the click
     simply appeared to fail. This shows the address and number instead,
     with copy buttons, and still offers mailto for anyone who wants it. */
  (function () {
    ...
    pop.querySelectorAll('[data-copy]').forEach(function (btn) {
      btn.addEventListener('click', function () {
        ...
        /* clipboard API needs a secure context and can be blocked; the
           textarea route still works when it is not available. */
        function fallback() {
